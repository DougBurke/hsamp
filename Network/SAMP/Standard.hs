...
>
>     -- Store metadata in hub for use by other applications.
>     let md = (tRS "dummy.version", toSValue (tRS "0.1-3")))
>              : toMetadata (tRS "dummy") (Just (tRS "Test Application"))
...
>     let mparams = [(tRS "filename", toSValue (tRS "/tmp/foo.bar")]
>     msg <- toSAMPMessage mt mparams
